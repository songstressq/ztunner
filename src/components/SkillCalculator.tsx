...
export default function SkillCalculator({
  ...
  const getSkillDataFromMarker = (
    ...
    const data: Record<string, { icon: string; name: string }> = {
      "[EX]": {
        icon:
          agentSpecialty === "Rupture"
            ? "{`${import.meta.env.BASE_URL}resources/images/icons/skilltypes/ex_rupture.png"
            : "{`${import.meta.env.BASE_URL}resources/images/icons/skilltypes/ex.png",
        name: "EX Special Attack",
      },
      "[ULTIMATE]": {
        icon: "{`${import.meta.env.BASE_URL}resources/images/icons/skilltypes/ultimate.png",
        name: "Ultimate",
      },
      "[CHAIN]": {
        icon: null,
      ...
      "[BASIC]": {
        icon: "{`${import.meta.env.BASE_URL}resources/images/icons/skilltypes/basic.png",
        name: "Basic Attack",
      },
      "[SPECIAL]": {
        icon: "{`${import.meta.env.BASE_URL}resources/images/icons/skilltypes/special.png",
        name: "Special Attack",
      },
      "[DODGE]": {
        icon: "{`${import.meta.env.BASE_URL}resources/images/icons/skilltypes/dodge.png",
        name: "Dodge",
      },
      "[COUNTER]": {
        icon: null,
      ...
      "[QUICK]": {
        icon: "{`${import.meta.env.BASE_URL}resources/images/icons/skilltypes/quick.png",
        name: "Quick Assist",
      },
      "[PERFECT]": {
        icon: null,
      ...
      "[ASSIST]": {
        icon: "{`${import.meta.env.BASE_URL}resources/images/icons/skilltypes/assist.png",
        name: "Assist",
      },
    };
          ...
          >
            ...
            <div className="totalize-header">
              <div className="totalize-header-left">
                <img
                  src="{`${import.meta.env.BASE_URL}resources/images/icons/skilltypes/ultimate_white.png"
                  alt="ultimate"
