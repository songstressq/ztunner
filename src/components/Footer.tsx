...
const Footer: React.FC<FooterProps> = ({
  ...
  const linkClass =
    linkVariant === "manager" ? "manager-social-link" : "social-link";

  return (
    <div
      className="social-footer"
      style={{
        backgroundColor: `color-mix(in srgb, ${theme} 6%, transparent)`,
