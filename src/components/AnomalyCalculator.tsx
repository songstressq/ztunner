          ...
          <div className="anomaly_summary-main_wrapper">
            <div className="anomaly-grid-header">
              <div className="anomaly-title-with-icon">
                <img
                  src={`{`${import.meta.env.BASE_URL}resources/images/icons/attributes/${
      ...
      {agent.id === "alice" && (
        <div className="anomaly_summary-main_wrapper">
          <div className="anomaly-grid-header">
            <div className="anomaly-title-with-icon">
              <img
                src="{`${import.meta.env.BASE_URL}resources/images/icons/attributes/Physical.png"
                alt="Physical"
                className="anomaly-attribute-icon"
              />
              <span className="anomaly-title-text">
      ...
      {agent.id === "yanagi" && showDisorderSection && (
        <div className="anomaly_summary-main_wrapper" style={{ marginTop: 16 }}>
          <div className="anomaly-grid-header">
            <div className="anomaly-title-with-icon">
              <img
                src="{`${import.meta.env.BASE_URL}resources/images/icons/attributes/Electric.png"
                alt="Electric"
                className="anomaly-attribute-icon"
              />
              <span className="anomaly-title-text">
      ...
      {agent.id === "nangong_yu" && showDisorderSection && (
        <div className="anomaly_summary-main_wrapper" style={{ marginTop: 16 }}>
          <div className="anomaly-grid-header">
            <div className="anomaly-title-with-icon">
              <img
                src="{`${import.meta.env.BASE_URL}resources/images/icons/attributes/Ether.png"
                alt="Ether"
                className="anomaly-attribute-icon"
              />
              <span className="anomaly-title-text">
