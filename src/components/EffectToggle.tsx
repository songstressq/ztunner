              ...
              <img
                src={
                  (ownerAgentId || effect.ownerAgentId) === "gameMode"
                    ? "{`${import.meta.env.BASE_URL}resources/images/agents/icons/game_mode.png"
                    : ownerAgentId || effect.ownerAgentId
                      ? `{`${import.meta.env.BASE_URL}resources/images/agents/icons/${ownerAgentId || effect.ownerAgentId}.png`
                      : "{`${import.meta.env.BASE_URL}resources/images/agents/icons/game_mode.png"
                }
