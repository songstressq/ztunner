...
const Home = () => {
  ...
  const imageUrl = useMemo(() => {
    if (dominantAgent && !imageError) {
      return `{`${import.meta.env.BASE_URL}resources/images/agents/mindscape/${dominantAgent.id}_mindscape.png`;
    }
    // Fallback: imagen por defecto (puedes usar una imagen genérica)
    return ""; // o "{`${import.meta.env.BASE_URL}resources/images/agents/mindscape/default_mindscape.png"
              ...
              <div className="home_content-patch_main_grid">
                ...
                <div className="home_content-single_card">
                  ...
                  <div className="home_content-card_section order_2">
                    <div className="home_content-agent_image">
                      <div className="home_content-agent_icons">
                        ...
                        />
                        <img
                          src="{`${import.meta.env.BASE_URL}resources/images/icons/specialties/Anomaly.png"
                          alt="Anomaly"
                          className="remielle_icons"
                        />
                      </div>
                      <img
                        src="{`${import.meta.env.BASE_URL}resources/images/agents/other/remielle.png"
                        alt="Remielle Dan"
                  ...
                  <div className="home_content-card_section order_3">
                    <div className="home_content-agent_image">
                      <div className="home_content-agent_icons">
                        <img
                          src="{`${import.meta.env.BASE_URL}resources/images/icons/attributes/Ice.png"
                          alt="Ice"
                      ...
                      <img
                        src="{`${import.meta.env.BASE_URL}resources/images/agents/other/sigrid.png"
                ...
                <div className="home_content-single_card">
                  ...
                  <div className="home_content-card_section order_2">
                    <div className="home_content-agent_image">
                      <img
                        src="{`${import.meta.env.BASE_URL}resources/images/wengines/knights_extolment.png"
                  ...
                  <div className="home_content-card_section order_3">
                    <div className="home_content-agent_image">
                      <img
                        src="{`${import.meta.env.BASE_URL}resources/images/wengines/ode_of_resurrected_wings.png"
                ...
                <div className="home_content-single_card">
                  ...
                  <div className="home_content-card_section order_2">
                    <div className="home_content-agent_image">
                      <img
                        src="{`${import.meta.env.BASE_URL}resources/images/sets/feathered_fate.png"
                        alt="Feathered Fate"
                        className="remielle_img no_agent_icon"
                      />
                    </div>
                  ...
                  <div className="home_content-card_section order_3">
                    <div className="home_content-agent_image">
                      <img
                        src="{`${import.meta.env.BASE_URL}resources/images/sets/thorned_rose.png"
                        alt="Thorned Rose"
